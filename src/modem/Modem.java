...
import static programmer.Programmer.jProgressBar1;
...
class Modem {
     ...
     * @throws java.io.IOException
     */
    protected void send(String pathToResourceFile, boolean useBlock1K) throws IOException {
        //open file  
...
//        try (DataInputStream dataStream = new DataInputStream(this.getClass().getResourceAsStream(pathToResourceFile))) {
    ...
    protected void sendDataBlocks(DataInputStream dataStream, int blockNumber, CRC crc, byte[] block) throws IOException {
        ...
        while ((dataLength = pmis.read(block)) != -1) {

            sendBlock(blockNumber++, block, dataLength, crc);
            //programmer.Programmer.jProgressBar1.setValue(blockNumber/numberOfBlocks*100);
